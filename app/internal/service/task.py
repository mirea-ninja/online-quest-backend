...
class TaskService:
    ...
    async def is_all_tasks_done(self, user_id: int) -> bool:
        all_user_answers = await self.repository.get_user_answers(user_id)
        ...
        if all_user_answers:
            ...
            return last_answer.task_unique_number == 10 and last_answer.is_correct
        else:
            return False
