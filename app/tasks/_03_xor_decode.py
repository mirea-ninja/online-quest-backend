...
def get_task() -> TaskModel:
    return TaskModel(
        ...
        question="Ну вот мы и подошли к месту, где находятся все наши мастера и ученики — деревне панд клана IIT. Для "
                 "того, чтобы попасть за ворота, тебе необходимо доказать свою эрудированность, сможешь ли ты "
                 "разгадать шифр? Таинственные силы оставили этот текст: XOR приведет тебя к ответу.",
        text="[494852, 494851, 494852, 494848, 494859, 494865, 494879, 494901, 494872, 494901, 494852, 494938, "
             "494877, 494901, 494861, 494938, 494938, 494862, 494901, 494859, 494878, 494901, 494866, 494938, 494872, "
             "494901, 494856, 494941, 494941, 494863, 494943, 494860, 494943, 494941, 494871]",
        media_links=[],
    )
