...
def get_task() -> TaskModel:
    return TaskModel(
        ...
        question="Ну вот мы и подошли к месту, где находятся все наши мастера и ученики — деревне панд клана IIIT. Для того, чтобы попасть за ворота, тебе необходимо доказать свою эрудированность, сможешь ли ты разгадать шифр?",
