...
def get_task() -> TaskModel:
    return TaskModel(
        ...
        question="Ты доказал, что можешь совладать со своим разумом и умеешь концентрироваться в нужный момент, внутренний покой ты обрёл, но это не конец твоего пути, теперь ты готов к следующему этапу, тебе предстоит разгадать послание “простой квадрат”, в котором зашифрована твоя цель.",
