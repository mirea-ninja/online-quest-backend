...
def get_task() -> TaskModel:
    return TaskModel(
        ...
        question="Настоящий мастер должен быть смекалистым, чтобы вести свой клан вперед. Сейчас мы проверим "
                 "насколько твои движения быстры, а ум ясен. Сможешь ли ты отыскать то, что мы спрятали в тексте",
